 ...
 */
public class TNGDyn implements YCPDynamicConditionEx {

	/**
	 * Logger instance
	 */
	private static YFCLogCategory mLogger = YFCLogCategory.instance(TNGDyn.class);
	...
	static {
		TNGDyn.mIsDebugEnabled = TNGDyn.mLogger.isDebugEnabled();
	}
	...
	private void debug(String aMsg) {
		if (TNGDyn.mIsDebugEnabled) {
			TNGDyn.mLogger.debug(aMsg);
		}
	}
}
